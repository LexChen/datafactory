...
public class DateColumn extends Column {
    ...
    protected void setupIncrement(IncrementNode incrementNode) {
        this.generator = new DateIncrement(incrementNode.getStart(),incrementNode.getEnd(),incrementNode.getStep());
    }

    @Override
    protected void setupRandom(RandomNode randomNode) {
        this.generator = new DateRandom(randomNode.getMin(),randomNode.getMax());
    }
