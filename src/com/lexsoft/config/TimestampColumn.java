...
public class TimestampColumn extends Column {
    ...
    protected void setupIncrement(IncrementNode incrementNode) {
        this.generator = new TimestampIncrement(incrementNode.getStart(),incrementNode.getEnd(),incrementNode.getStep());
    }

    @Override
    protected void setupRandom(RandomNode randomNode) {
        this.generator = new TimestampRandom(randomNode.getMin(),randomNode.getMax());
    }
